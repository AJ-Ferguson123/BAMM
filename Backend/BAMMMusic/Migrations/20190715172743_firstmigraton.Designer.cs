...
namespace BAMMMusic.Migrations
{
    ...
    [Migration("20190715172743_firstmigraton")]
            ...
            modelBuilder.Entity("BAMMMusic.Model.Artist", b =>
                {
                    ...
                    b.HasData(
                        new { ArtistId = 1, Age = 57, ArtistImage = "princeMusician1.jpg", ArtistName = "Prince", Hometown = "Minneapolis, Minnesota" },
                        new { ArtistId = 2, Age = 49, ArtistImage = "queen2.jpg", ArtistName = "Queen", Hometown = "London" }
                    );
                });
