...
namespace BAMMMusic.Migrations
{
    ...
    [Migration("20190724185811_changedate")]
            ...
            modelBuilder.Entity("BAMMMusic.Model.Album", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { AlbumId = 3, AlbumImage = "https://upload.wikimedia.org/wikipedia/en/0/05/Queen_Live_Killers.png", AlbumTitle = "Live Killers", ArtistId = 2, Date = "1979", Label = "EMI-Elektra" },
